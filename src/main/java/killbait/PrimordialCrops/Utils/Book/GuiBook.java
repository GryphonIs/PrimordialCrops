...
public class GuiBook extends GuiScreen {
	...
	public void drawBackground(int scalew, int scaleh, int scalef) {
		...
		drawCenteredString(mc.fontRenderer, obj.toString(), scalew/2, scaleh/2, Integer.parseInt("FFAA00", 16));

		Object obj2 = "Scaled Resolution width= " + scalew + " , height = " + scaleh + " , scaleFactor = " + scalef;
		drawCenteredString(mc.fontRenderer, obj2.toString(), scalew/2, scaleh/2 + 16, Integer.parseInt("FFAA00", 16));

		Object ob3 = "GlStateManager.scale " + scale;
		drawCenteredString(mc.fontRenderer, ob3.toString(), scalew/2, scaleh/2 + 32, Integer.parseInt("FFAA00", 16));*/
	}
